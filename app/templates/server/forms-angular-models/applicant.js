...
var ApplicantSchema = new Schema({
  ...
  photo: {type: [new Schema(jqUploads.FileSchema)], form: { true, directive: 'fng-jq-upload-form', fngJqUploadForm:{sizeLimit:524288, autoUpload:true, single:true, width: 100, height: 100 }}},<% } %><% if(filters.ckeditor) { %>,
